...
export default function CreateClaim() {
  ...
  const handleSubmit = async () => {
    ...
    const rulesValidation = rules.trim()
      ? validateUserContent(rules, 'comment')
      : { isValid: true };

    if (!titleValidation.isValid) {
      Alert.alert(
        'Validation Error',
        titleValidation.errorMessage || 'Please review your title'
      );
      return;
    }
    ...
    if (!claimValidation.isValid) {
      Alert.alert(
        'Validation Error',
        claimValidation.errorMessage || 'Please review your claim'
      );
      return;
    }
    ...
    if (!rulesValidation.isValid) {
      Alert.alert(
        'Validation Error',
        rulesValidation.errorMessage || 'Please review your rules'
      );
      return;
    }
    ...
    if (claimValidation.warning)
      warnings.push('Claim: ' + claimValidation.warning);
    if (rulesValidation.warning)
      warnings.push('Rules: ' + rulesValidation.warning);
  ...
  const submitClaim = async (
    ...
    try {
      ...
      Alert.alert('Success!', 'Your claim has been created successfully!', [
        {
          text: 'OK',
          onPress: () => {
            // Reset form
        ...
        <ScrollView style={styles.scrollContainer}>
          ...
          <View style={styles.inputGroup}>
            <Text style={styles.label}>
              Support your claim with all your soul *
            </Text>
            <TextInput
              ref={claimInputRef}
